...
# Known, active Osho Facebook PAGES to scrape (page-based scraping is RELIABLE;
# keyword search on FB is not). Add/remove pages freely.
FB_PAGES = [
...
POSTS_PER_QUERY = 50          # more posts per run = more chances to find real events
